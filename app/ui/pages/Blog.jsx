...
const posts = [
  ...
  export const Blog = () => {
    ...
    return (
      <div id="footer" className="relative bg-white dark:bg-slate-800 rounded-lg py-8 ring-1 ring-slate-900/5 shadow-xl pt-16 pb-20 px-4 sm:px-6 lg:pt-24 lg:pb-28 lg:px-8">
                ...
                <div className="flex-1 bg-white dark:bg-slate-800 rounded-lg py-8 ring-1 ring-slate-900/5 shadow-xl p-6 flex flex-col justify-between">
                  <div className="flex-1" data-aos="fade-right">
                    <p className="text-sm font-medium text-cyan-600">
                      <a href={post.category.to} className="hover:underline">
                        {post.category.name}
                      </a>
                    </p>
